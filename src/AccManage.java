...
public class AccManage {
    ...
    public AccManage(){
        UserAccount user1 = new UserAccount(1,"leang",20.0);
        UserAccount user2 = new UserAccount(2,"Mich",30.50);
        UserAccount user3 = new UserAccount(3,"phea",40.50);
    ...
    public void addAccount(){
        System.out.println(" Form account infor");
    ...
    public void showAccounts(){
        ...
        do {
            ...
            System.out.print(" Confirm 1 for continue show and sort  : ");
            System.out.println("");
